...
import de.fhws.fiw.fds.exam03.server.api.messagebodywriter.EventHtmlWriter;
import de.fhws.fiw.fds.exam03.server.api.messagebodywriter.EventsHtmlWriter;
...
public class Exam03Application extends AbstractApplication
{
	...
	protected Set<Class<?>> getServiceClasses( )
	{
		...
		returnValue.add( EventHtmlWriter.class );
		returnValue.add( EventsHtmlWriter.class );
