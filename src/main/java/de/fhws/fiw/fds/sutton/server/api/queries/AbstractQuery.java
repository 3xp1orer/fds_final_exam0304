...
public abstract class AbstractQuery<T extends AbstractModel>
{
	...
	{
		this.pagingBehavior.addPrevPageLink( pagingContext );				// todo hier liegt noch kein link vor ...
	}

	public final void addNextPageLink( final PagingContext pagingContext )
	{
		this.pagingBehavior.addNextPageLink( pagingContext, this.result );	// todo hier liegt noch kein link vor ...
	}
}
